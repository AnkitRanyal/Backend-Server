...
const transporter = nodemailer.createTransport({
    service:"gmail",
    auth:{
        user: "ankitranyal0000@gmail.com",
        pass: 'aakbayzvpaecskiv'
    }
})
...
exports.sendMail =async function ({to, subject, text, html}) {
    let info = await transporter.sendMail({
        from: 'ankitranyal0000@gmail.com', // sender address
        to,
        subject,
        text,
        html
...
exports.main = async function (firstName,email,otp,{subject,html}){
  const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: "ankitranyal0000@gmail.com",
...
const mailoptions = {
    from: "ankitranyal0000@gmail.com",
    to: email,
    subject: 'Please confirm your OTP',
    text: `${firstName} Hello Please confirm your OTP`,
    html:html
}
               ...
               <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                 <table border="0" cellpadding="0" cellspacing="0" width="100%">
                   ...
                   ${order.items.map(item=>`<tr>
                     <td align="left" width="60%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${item.items}</td>
                     ...
                     <td align="left" width="20%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">&#8377;${Math.round(item.price*(1-item.discountPercentage/100),2)}</td>
                   </tr>`)
                   ...
                   <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                     <tr>
                       <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                         ...
                         <p>${order.selectedAddress.name}<br>${order.selectedAddress.LandMark}<br>${order.selectedAddress.City},${order.selectedAddress.State},${order.selectedAddress.Pincode}</p>
